...
class PTdcmotor {
public:
  // Constructor using Arduino pins
  ...
  // Constructor using PCF8574
  PTdcmotor(Adafruit_PWMServoDriver& driver, uint8_t channel, Adafruit_PCF8574& pcf, uint8_t in1, uint8_t in2) :
      pwmDriver(driver), pwmChannel(channel), pcfBoard(&pcf), pin1(in1), pin2(in2){
...
private:
  ...
  uint8_t pin1;
  uint8_t pin2;
  bool usePcf;  // Flag to check whether to use PCF8574 or regular digital pins
};
